...
public:
    StandUpController(uint8_t level): safe(LeggedType::B1),
...
private:
    ...
    int standup_duration = 1000;  // 站起持续时间
    int liedown_duration = 1000;  // 趴下持续时间
...
void StandUpController::RobotControl() {
    ...
    if (currentState == STANDING_UP) {
        ...
        if (motiontime <= standup_duration) {
            ...
            std::cout << "FR q Error: " << 
                         (cmd.motorCmd[0].q - state.motorState[0].q) * 180 / 3.1415 << ", " <<
                         (cmd.motorCmd[1].q - state.motorState[1].q) * 180 / 3.1415 << ", " <<
                         (cmd.motorCmd[2].q - state.motorState[2].q) * 180 / 3.1415 << " --- " << 
                         "FL q Error: " <<
                         (cmd.motorCmd[3].q - state.motorState[3].q) * 180 / 3.1415 << ", " <<
                         (cmd.motorCmd[4].q - state.motorState[4].q) * 180 / 3.1415 << ", " <<
                         (cmd.motorCmd[5].q - state.motorState[5].q) * 180 / 3.1415 << " --- " <<
                         "RR q Error: " <<
                         (cmd.motorCmd[6].q - state.motorState[6].q) * 180 / 3.1415 << ", " <<
                         (cmd.motorCmd[7].q - state.motorState[7].q) * 180 / 3.1415 << ", " <<
                         (cmd.motorCmd[8].q - state.motorState[8].q) * 180 / 3.1415 << " --- " <<
                         "RL q Error: " <<
                         (cmd.motorCmd[9].q - state.motorState[9].q) * 180 / 3.1415 << ", " <<
                         (cmd.motorCmd[10].q - state.motorState[10].q) * 180 / 3.1415 << ", " <<
                         (cmd.motorCmd[11].q - state.motorState[11].q) * 180 / 3.1415 << std::endl;
        } else {
